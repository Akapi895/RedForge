...
| Need | Profile |
| --- | --- |
| Individual development | Local Development |
| Internal team use | Internal Team |
| Documentation or knowledge questions | Knowledge-Only Assistant |
| Long-running production platform | High-Audit Production |
| Authorized C2 exercise | C2 Exercise Window |
| Internal tool platform | External MCP Automation |
