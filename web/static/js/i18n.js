...
(function () {
    ...
    async function changeLanguage(lang) {
        if (typeof i18next === 'undefined') return;
        // This fork is English-only. Keep the function for compatibility with
        // older page scripts, but never load or switch to another locale.
        lang = DEFAULT_LANG;
